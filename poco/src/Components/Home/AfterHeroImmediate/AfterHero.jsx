  ...
  return (
    <div className="flex flex-col h-[140%] px-8 pb-40 gap-20 justify-center">
        ...
        <article className="flex gap-[1.1rem] h-fit w-full flex-wrap items-center justify-center">
            <main className="h-63 bg-pink-100 hover:bg-amber-400 duration-300 gap-6 w-55 rounded-2xl flex flex-col items-center justify-center group">
            ...
            <main className="h-63 bg-pink-100 hover:bg-amber-400 duration-300 w-55 gap-6 rounded-2xl flex flex-col items-center justify-center group">
                <span className="bg-white h-25 w-25 rounded-full">
