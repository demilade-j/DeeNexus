  ...
  return (
    <div className="p-20 bg-green-800 text-white pt-48 px-12  justify-between gap-[10%] md:grid-cols-1 lg:flex grid-cols-1 sm:grid-cols-1 sm:items-center sm:justify-center md:items-center md:justify-center hero-2">
      <div className="flex flex-col items-center justify-center lg:flex lg:flex-col lg:items-start">
        <img
          className="absolute ml-50 hero-1-onion md:mt-[-70%] md:ml-[-30rem] lg:mt-[-23%] lg:ml-[48%]"
          src="/onion hero.png"
        />
        <img
          className="absolute  mt-170 ml-40 lg:ml-[40%] lg:mt-[-34%] hero-1-discount md:mt-[80%]"
          src="/50off poco.png"
        />

        <img
          width={200}
          className="absolute z-7 ml-200 mt-[-11.4rem] hero-1-tomato lg:hidden sm:hidden md:flex md:ml-[30rem] md:mt-[-49rem] hidden"
          src="/Tomato Poco.png"
        />
        <img
          width={50}
          className="absolute lg:ml-[80%] lg:mt-[35%] hero-leaf-btn sm:ml-12 ml-[50%]"
          src="/chilli 2.png"
        />
        <img
          width={150}
          className="absolute hidden lg:ml-90 mt-[40%] md:ml-100 hero-1-chilli sm:ml-12 ml-[50%]"
          src="/Chilli 2 poco.png"
        />
        ...
        <img
          width={100}
          className=" mt-[-1.4rem] ml-10 z-[1] hero-leaf-btn"
          src="/leaf 1.webp"
          alt=""
        />
        <br />
