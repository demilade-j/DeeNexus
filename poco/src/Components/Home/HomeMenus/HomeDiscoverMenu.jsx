...
export default function HomeDiscoverMenu() {
  return (
    <div className="lg:flex md:grid-cols-1 py-20 bg-white items-center justify-center lg:px-10 md:px-10 px-5 gap-20">
      <main className="flex flex-col items-start gap-3">
        ...
        <article className="flex gap-7 items-center justify-center">
          <Link to='/menu'><button className="bg-amber-400 px-8 py-3 cursor-pointer font-bold rounded-lg lg:text-lg text-sm">View Our Menu</button></Link> 
          <Link to='/shop'>
          <span className="bg-none flex gap-3 font-medium lg:text-lg text-sm items-center justify-center">View All Products
      ...
      <main className="flex items-center justify-center lg:pt-0 pt-6">
        <img className='lg:w-[100%] w-[60%]' src="/discover home pic.png" alt="" />
