...
<div
      ...
      >
        ...
        <article className="flex gap-6">
          ...
          <span className="border-gray-500 border-2 h-10 w-10 flex items-center justify-center rounded-[100%] hover:bg-amber-400"><LucideShoppingBasket fill="black"/></span>
        </article>
    </div>
      </div>
  )
