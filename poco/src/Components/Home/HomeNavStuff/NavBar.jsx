    ...
    >
      ...
      <span className="lg:hidden md:flex sm:flex flex h-16 items-center justify-between px-6">
        ...
        >
          <button
            onClick={() => setOpen(false)}
            className="text-2xl ml-60 mt-5 hover:text-amber-400"
          >
            &times;
          </button>
          <br />
      ...
      <span className="lg:hidden md:hidden sm:flex flex h-13 items-center justify-end px-6 gap-10">
        ...
        <main className="flex gap-4">
          <span
            ...
            className="border-gray-500 border-2 h-10 w-10 flex items-center justify-center rounded-[100%] hover:bg-amber-400"
          >
            <Search size={25} />
          </span>
          <span
