...
const products = [
  {
    ...
    price: "£6.99",
    description:
      "Smoky BBQ sauce, crispy bacon, sharp cheddar, and a perfectly grilled beef patty. Messy but totally worth it!",
  ...
  },
  {
    ...
    price: "£8.99",
    description:
      "Tender pulled pork, tangy BBQ sauce, and crunchy coleslaw on a toasted bun. A Southern classic with a twist!",
  ...
  },
  {
    ...
    price: "£5.99",
    description:
      "A hearty black bean patty with spices, topped with avocado and chipotle mayo. A delicious vegetarian option!",
  ...
  },
  {
    ...
    price: "£6.99",
    description:
      "A breakfast twist with a fried egg, crispy bacon, and melted cheese on a beef patty. Perfect for any time of day!",
  ...
  },
  {
    ...
    price: "£4.99",
    description:
      "A timeless classic with a juicy beef patty, melted cheese, lettuce, tomato, and pickles. Simple and satisfying!",
  ...
  },
  {
    ...
    price: "£7.99",
    description:
      "For the brave! A beef patty topped with habanero peppers, pepper jack cheese, and spicy mayo. Extreme heat!",
  ...
  },
  {
    ...
    price: "£7.49",
    description:
      "A tropical delight with teriyaki sauce, grilled pineapple, and a beef patty. Sweet and savory in every bite!",
  ...
  },
  {
    ...
    price: "£8.99",
    description:
      "A flavorful lamb patty with tzatziki sauce, feta cheese, and fresh veggies. A taste of the Mediterranean!",
  ...
  },
  {
    ...
    price: "£6.49",
    description:
      "For heat lovers! A beef patty topped with jalapeños, pepper jack cheese, and spicy mayo. Fire up your taste buds!",
  ...
  },
  {
    ...
    description:
      "Indulge in luxury! A beef patty topped with truffle butter, arugula, and shaved Parmesan. Sophisticated and delicious!",
    price: "£8.99",
    deletedPrice: "£9.99",
