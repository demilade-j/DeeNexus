...
const products = [
  ...
  },
  {
    ...
    price: "£5.49",
    description:
      "Rich, creamy, and chocolatey. A classic treat for any time of day.!",
  ...
  },
  {
    ...
    price: "£4.99",
    description:
      "Pure coconut water with a splash of lime. Hydrating and refreshing!",
  ...
  },
  {
    ...
    deletedPrice: "£3.99",
    description:
      "Classic iced tea with a sweet peach twist. Refreshing and fruity!",
  ...
  },
  {
    ...
    price: "£4.49",
    description:
      "Pineapple, coconut, and a hint of lime. Taste the tropics in every sip!",
        ...
        {products.map((products) => (
          ...
          >
            <main className="w-full h-[90%] flex gap-7 items-center relative justify-center bg-[#ffbbbb] rounded-4xl">
              <img
                className="lg:h-50 lg:w-66 md:w-50 sm:w-40 w-35"
                src={products.src}
                alt=""
              />
