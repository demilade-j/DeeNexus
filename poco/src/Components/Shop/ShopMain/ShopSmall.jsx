...
import { Heart, LayoutGrid, Logs } from "lucide-react";
import { useNavigate } from "react-router-dom";
  ...
  const products = [
    ...
    },
    {
      ...
      price: "£6.99",
      description:
        "Smoky BBQ sauce, crispy bacon, sharp cheddar, and a perfectly grilled beef patty. Messy but...",
    ...
    },
    {
      ...
      price: "£4.99",
      description:
        "Creamy matcha green tea blended with milk and a touch of honey. Refreshing and energi...",
      src: "/londonfog.webp",
    },
    {
      id: 10,
      ...
      price: "£7.49",
      description:
        "Creamy blue cheese, crispy bacon, and a juicy beef patty. A bold flavor combination for che...",
    ...
    },
    {
      ...
      price: "£6.99",
      description:
        "A breakfast twist with a fried egg, crispy bacon, and melted cheese on a beef patty. Perfect for any...",
    ...
    },
    {
      ...
      price: "£5.49",
      description:
        "Creamy matcha green tea blended with almond milk and honey. A refreshing, energizing...",
    ...
    },
    {
      ...
      price: "£3.99",
      description:
        "Spicy buffalo sauce, tangy blue cheese, and a crispy chicken patty. A fiery favorite for spice...",
    ...
    },
    {
      ...
      price: "£5.49",
      description:
        "Warm milk infused with turmeric, ginger, and a hint of black pepper. A healing, golden break...",
    ...
    },
    {
      ...
      price: "£7.99",
      description:
        "For the brave! A beef patty topped with habanero peppers, pepper jack cheese, and spicy...",
    ...
    },
    {
      ...
      price: "£5.49",
      description:
        "Earl Grey tea infused with lavender, steamed milk, and a touch of honey. Floral and...",
    ...
    },
    {
      ...
      price: "£8.99",
      description:
        "Penne pasta in a fiery tomato sauce with garlic, chili flakes, and fresh basil. Perfect for spice...",
    ...
    },
    {
      ...
      deletedPrice: "£11.99",
      description:
        "Spicy Cajun-seasoned shrimp served over fettuccine pasta in a creamy Alfredo sauce. Bold and...",
    ...
    },
    {
      ...
      description:
        "Homemade ravioli stuffed with roasted butternut squash, served in a sage brown butter sauce...",
      price: "£11.99",
    ...
    },
    {
      ...
      price: "£5.99",
      description:
        "Creamy guacamole, crispy bacon, and a juicy beef patty. A fresh and flavorful twist on the classic...",
    ...
    },
    {
      ...
      deletedPrice: "£5.49",
      description:
        "Creamy matcha green tea blended with milk and a touch of honey. Refreshing and...",
    ...
    },
    {
      ...
      price: "£7.49",
      description:
        "A tropical delight with teriyaki sauce, grilled pineapple, and a beef patty. Sweet and savory in...",
      src: "/hawaiianteriyakiburger.webp",
    },
    {
      id: 32,
      name: "Mint Mojito (Non-Alco...",
      deletedPrice: "£5.49",
      price: "£4.99",
      description:
    ...
    },
    {
      ...
      deletedPrice: "£11.99",
      description:
        "Spicy Cajun-seasoned chicken breast served over penne pasta in a creamy Alfredo sauce. Bold...",
    ...
    },
    {
      ...
      price: "£6.99",
      description:
        "A spicy treat with jalapeno poppers, cream cheese, and a beef patty. Perfect for those...",
    ...
    },
    {
      ...
      description:
        "Espresso, steamed milk, and vanilla syrup, topped with caramel drizzle. A sweet and...",
      price: "£5.49",
      src: "/caramelmacchiato.webp",
    },
    {
      id: 39,
      name: "Lemon Garlic Shrimp Lin",
      deletedPrice: "£12.99",
      price: "£11.99",
      description:
    ...
    },
    {
      ...
      price: "£8.99",
      description:
        "A flavorful lamb patty with tzatziki sauce, feta cheese, and fresh veggies. A taste of the...",
    ...
    },
    {
      ...
      price: "£11.49",
      description:
        "Breaded chicken breast served over spaghetti with marinara sauce and melted mozzarella...",
      src: "/chickenparmesanpasta.webp",
    },
    {
      id: 43,
      name: "Tropical Pineapple Smoot...",
      deletedPrice: "£4.99",
      price: "£4.49",
      description:
    ...
    },
    {
      ...
      price: "£6.99",
      description:
        "Sautéed mushrooms, melted Swiss cheese, and a juicy beef patty on a toasted bun. Earthy...",
    ...
    },
    {
      ...
      deletedPrice: "£8.99",
      description:
        "Fresh basil pesto tossed with penne pasta, cherry tomatoes, and Parmesan. Bright and...",
      src: "/pestopenne.webp",
    },
    {
      id: 47,
    ...
    },
    {
      ...
      price: "£9.49",
      description:
        "A colorful mix of fresh vegetables tossed with penne pasta in a light garlic olive oil sauce. Healthy...",
      src: "/pastaprimavera.webp",
    },
    {
      id: 50,
      name: "Strawberry Banana Smo...",
      price: "£4.49",
      description:
    ...
    },
    {
      ...
      price: "£6.49",
      description:
        "For heat lovers! A beef patty topped with jalapeños, pepper jack cheese, and spicy mayo...",
    ...
    },
    {
      ...
      price: "£5.99",
      description:
        "Creamy matcha green tea blended with steamed milk and a touch of honey. Energizing and...",
    ...
    },
    {
      ...
      description:
        "Indulge in luxury! A beef patty topped with truffle butter, arugula, and shaved Parmesan...",
      price: "£8.99",
      deletedPrice: "£9.99",
    ...
    },
    {
      ...
      price: "£9.99",
      description:
        "Jumbo pasta shells stuffed with a creamy spinach and ricotta filling, baked in marinara sauce...",
      src: "/spinachricottastuffedshells.webp",
    },
    {
      id: 68,
      name: "Truffle Mushroom Fettu...",
      deletedPrice: "£12.99",
      price: "£11.99",
      description:
    ...
    },
    {
      ...
      description:
        "A plant-based patty with avocado, spinach, and a tangy vegan sauce. Healthy and...",
      price: "£4.99",
      deletedPrice: "£5.99",
    ...
    },
    {
      ...
      price: "£9.49",
      description:
        "Rich, creamy Alfredo sauce with plump, juicy shrimp over fettuccine pasta. Absolutely...",
...
export default function ShopSmall() {
    ...
    <div className="py-15 w-[75%]">
      ...
      <main className="flex gap-3 w-full ps-2 flex-wrap">
        {sortedProducts.map((product) => (
          ...
          >
            <br />
            <button className="absolute mb-[23rem] ml-[65%] group-hover:text-amber-400 text-white duration-1000">
            ...
            <div className="ml-[-.5rem]">
              ...
              <span className="flex gap-6 pl-1 font-extrabold text-lg">
                <del className="text-gray-700">{product.deletedPrice}</del>
                <main className="text-amber-600">{product.price}</main>
              </span>
              <CartOnclick
                key={product.id}
                products={product}
